...
namespace Game.UI
{
    public class HUDMenu : BasePanel
    {
        ...
        [SerializeField] private Button openBagMenuButton;

        protected override void Awake()
        {
            base.Awake();
            openBagMenuButton.onClick.AddListener(OnOpenBagMenuButtonClicked);
        }
        ...
        void OnOpenBagMenuButtonClicked()
        {
            Debug.Log("Click OnOpenBagMenuButtonClicked");
